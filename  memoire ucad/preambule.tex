...
\begin{titlepage}
\begin{center}
\includegraphics[height=2cm,width=2cm]{UcadLogo} \qquad 
{\bf Universit\'e Cheikh Anta Diop de Dakar (UCAD)} \qquad
...
generalement des
 ...
 Des nombreuses applications peuvent \^etre mod\'elis\'ees sous la formes de problemes d'optimisation en nombres entiers telles que le voyageur de commerce, le probl\`eme
 de coloration de graphe, lee proble\`emes de localisation etc.
...
De ce fait, il a beaucoup contribu\'e au d\'emarrage de l'optimisation num\'erique. L'algorithme du simplexe a longtemps \'et\'e la m\'ethode la plus utilis\'ee
 ...
 probl\`emes dont l'ensemble des contraintes pr\'esente certaines particularit\'es.
...
\bibitem{acherga}
Acher J. ; Gadelle J : 
\emph{Programmation Lin\'eare.} Dunod D\'ecision, Bordas, Paris, 1978, Troisi\`eme \'edition .
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibitem{cea}
C\'ea J. : 
