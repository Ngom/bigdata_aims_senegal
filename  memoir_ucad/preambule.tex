...
\ding{43} Les m\'etaheuristiques peuvent contenir des m\'ecanismes qui permettent d'eviter d'\^etre bloqu\'e dans des regions de l'espace de recherche.

\ding{43} Les concepts de base des m\'etaheuristiques peuvent \^etre d\'ecrits de mani\`ere abstraite, sans faire appel \`a un probl\`eme sp\'ecifique.

\ding{43} Les m\'etaheuristiques peuvent faire appel \`a des heuristiques qui tiennent compte de la sp\'ecificit\'e du probl\`eme trait\'e, mais ces
heuristiques sont contr\^ol\'ees une strat\'egie de niveau sup\'erieur.

\ding{43} Les m\'etaheuristiques peuvent usage de l'exp\'erience accumul\'ee durant la recherche de l'optimum pour mieux guider la suite du processus de 
recherche.
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
